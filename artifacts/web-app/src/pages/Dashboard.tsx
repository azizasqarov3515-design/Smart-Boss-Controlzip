  ...
  return (
    <div style={{ padding: "16px", paddingBottom: "100px", display: "flex", flexDirection: "column", gap: "20px" }}>
      ...
      <div>
        ...
        <div className="card-glow-green" style={{ display: "flex", flexDirection: "row", alignItems: "center", gap: "12px", marginTop: "10px" }}>
          <span className="material-icons" style={{ color: colors.success, fontSize: "24px" }}>savings</span>
          <div style={{ flex: 1 }}>
            <span style={{ fontSize: "11px", color: colors.mutedForeground, display: "block" }}>Bugungi sof foyda</span>
      ...
      {lowStockProducts.length > 0 && (
        <div className="alert-card" style={{ borderColor: "#FFB300", backgroundColor: "rgba(255, 179, 0, 0.05)" }}>
