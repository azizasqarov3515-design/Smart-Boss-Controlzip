...
export const createCustomerDeleteRequest = async (
  createCustomerDeleteRequest: import("./api.schemas").CreateCustomerDeleteRequest,
  options?: RequestInit,
): Promise<import("./api.schemas").CreateCustomerDeleteRequest201> => {
  return customFetch<import("./api.schemas").CreateCustomerDeleteRequest201>(
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    { data: BodyType<import("./api.schemas").CreateCustomerDeleteRequest> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
...
/**
 * @summary Get worker's own delete requests (all statuses)
 */
...
export const getWorkerDeleteRequests = async (
  options?: RequestInit,
): Promise<import("./api.schemas").DeleteRequest[]> => {
  return customFetch<import("./api.schemas").DeleteRequest[]>(
    getGetWorkerDeleteRequestsUrl(),
    { ...options, method: "GET" },
  );
};
...
export const getGetWorkerDeleteRequestsQueryOptions = <
  ...
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<Awaited<ReturnType<typeof getWorkerDeleteRequests>>, TError, TData>;
  request?: SecondParameter<typeof customFetch>;
}) => {
  const { query: queryOptions, request: requestOptions } = options ?? {};
  const queryKey = queryOptions?.queryKey ?? getGetWorkerDeleteRequestsQueryKey();
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getWorkerDeleteRequests>>> = ({ signal }) =>
    getWorkerDeleteRequests({ signal, ...requestOptions });
  return { queryKey, queryFn, ...queryOptions } as UseQueryOptions<
